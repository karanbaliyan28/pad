...
const user = {
  name: 'Karan Baliyan',
  email: 'karanbaliyan28@example.com',
  imageUrl: 'https://images.pexels.com/photos/30570315/pexels-photo-30570315/free-photo-of-dark-knight-cosplay-with-red-accent.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2',
};

const navigation = [
  { name: 'Dashboard', href: '/dashboard', current: true },
  { name: 'Update Attendance', href: '#', current: false },
  { name: 'View Attendance Records', href: '#', current: false },
  { name: 'Manage Students', href: '#', current: false },
            ...
            <div className="flex h-16 items-center justify-between">
              <div className="flex items-center">
                <div className="shrink-0">
                  <img alt="Your Company" src="https://tailwindcss.com/plus-assets/img/logos/mark.svg?color=indigo&shade=500" className="h-8 w-8" />
                </div>
